	...
	return (function () {
		var e = {
				...
				8457: function (t, e, r) {
					...
					t.exports = function (t) {
						...
						if (
							...
							for (r = new v((e = u(h.length))); e > x; x++)
								(d = g ? y(h[x], x) : h[x]), s(r, x, d);
						else
							for (
				...
				7710: function (t, e, r) {
					...
					t.exports = function (t, e, r) {
						...
						if (
							...
							(x = r.getConstructor(e, t, v, y)), u.enable();
						else if (i(t, !0)) {
							var S = new x(),
								k = S[y](m ? {} : -0, 1) != S,
								O = f(function () {
					...
					t.exports = function (t, e, r, l, d, w, _) {
						...
						if (
							...
							if (
								...
								for (O in k)
									(v || A || !(O in C)) && c(C, O, k[O]);
							else n({ target: e, proto: !0, forced: v || A }, k);
						return k;
					};
				},
				7235: function (t, e, r) {
				...
				647: function (t, e, r) {
					var n = r(7908),
						...
						a = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
						u = /\$([$&'`]|\d{1,2})/g;
					t.exports = function (t, e, r, s, c, l) {
						var f = r + t.length,
							p = s.length,
							d = u;
						return (
					...
					(h && v) ||
						...
						d
							...
							: u.addEventListener &&
							  ...
							  'file:' !== n.protocol &&
							  !s(k)
							? ((o = k), u.addEventListener('message', S, !1))
							: (o =
				...
				8674: function (t, e, r) {
					...
					u({ global: !0, wrap: !0, forced: Z }, { Promise: q }),
						v(q, N, !1, !0),
						m(N),
						(i = l(N)),
						u(
							...
							return [
								...
								function (t, o) {
									...
									for (
										...
										var L = w.groups;
										if (y) {
											var P = [E].concat(A, j, d);
											void 0 !== L && P.push(L);
											var T = s(o.apply(void 0, P));
										} else T = f(E, d, j, A, L, o);
										j >= k &&
											((S += d.slice(k, j) + T),
											(k = j + E.length));
									}
				...
				2526: function (t, e, r) {
					...
					s ||
						...
						W.prototype[q] ||
							A(W.prototype, q, W.prototype.valueOf),
						N(W, B),
						(T[M] = !0);
				},
				4747: function (t, e, r) {
						...
						Et = function (t) {
							...
							if (void 0 !== o)
								if (o instanceof Et) e = k(o);
									...
									throw TypeError(r);
							if ((r = Ot(u, a, null, e))) throw TypeError(r);
		...
		return (
			(function () {
				...
				s.options.__file = 'packages/page-tabs/src/index.vue';
				var c = s.exports;
					...
					return new Promise(function (e, r) {
						if ('undefined' != typeof XMLHttpRequest) {
							var n = new XMLHttpRequest(),
								...
								i = t.url,
								a = [];
							for (var u in t.data) a.push(u + '=' + t.data[u]);
				...
				function A(t) {
					...
					if (e('array'))
						return t.map(function (t) {
							return 'object' === u(t) ? A(t) : t;
						});
					if (e('object')) {
						var r = {};
						for (var n in t)
							r[n] = 'object' === u(t[n]) ? A(t[n]) : t[n];
						return r;
					}
					if (e('function'))
				...
				function L(t, e) {
					...
					for (var o = 0; o < r.length; o++) {
						var i = r[o];
						if ('object' === u(t[i])) return L(t[i], e[i]);
				...
				W.options.__file = 'packages/form/src/index.vue';
				var H = W.exports;
				...
				var Dt = e(
					{
						name: 'DStatistic',
						props: { border: { type: String, default: 'bottom' } },
					},
					Nt,
					[],
					!1,
				...
				var Mt = Ut,
					Bt = function () {
						var t = this,
							e = t.$createElement,
							r = t._self._c || e;
						return r('div', { staticClass: 'd-statistic-item' }, [
							r(
								'div',
								{ staticClass: 'd-value', style: t.valueStyle },
								[
									t.$scopedSlots.value
										? t._e()
										: [t._v(t._s(t.value))],
				...
				function Zt(t) {
					Jt.forEach(function (e) {
						...
						(t.prototype.$modal = Kt),
						(t.prototype.$notice = Xt);
				}
				'undefined' != typeof window && window.Vue && Zt(window.Vue);
				var te = {
					install: Zt,
					Link: a,
					PageTabs: l,
